          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Daftar Transaksi/</span> Tambah Pengajuan</h4>
                      ...
                      <div class="form-password-toggle">
                        ...
                        <select class="form-select" id="jns_kendaraan" name="jns_kendaraan" required>
                          ...
                          <?php foreach ($data_mobil as $dt_data_mobil): ?>
                            <option value="<?=$dt_data_mobil['id_kendaraan'] ?>"><?=$dt_data_mobil['no_polisi'] ?> - <?=$dt_data_mobil['merk'] ?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
                      ...
                      <div class="form-password-toggle">
                        ...
                        <select class="form-select" id="sopir" name="sopir" required>
                          ...
                          <?php foreach ($data_sopir as $dt_data_sopir): ?>
                            <option value="<?=$dt_data_sopir['id_sopir'] ?>"><?=$dt_data_sopir['nama'] ?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
                    ...
                    <div class="card-body demo-vertical-spacing demo-only-element">
                      <div class="form-password-toggle">
                        <label class="form-label" for="basic-default-password12">Waktu Mulai</label>
                         <input type="datetime-local" id="jam_mulai_aktual" name="jam_mulai_aktual" class="form-control" placeholder="MM / DD / YY, HH:MM:TT" required>
                      </div>

                      <div class="form-password-toggle">
                        <label class="form-label" for="basic-default-password12">Waktu Selesai</label>
                         <input type="datetime-local" id="jam_selesai_aktual" name="jam_selesai_aktual" class="form-control" placeholder="MM / DD / YY, HH:MM:TT" required>
                      </div>
                      ...
                      <div class="form-password-toggle">
                        ...
                        <select class="form-select" id="id_pemeriksa" name="id_pemeriksa" required>
                          ...
                          <?php foreach ($data_atasan as $dt_data_atasan): ?>
                            <option value="<?=$dt_data_atasan['id_user'] ?>~<?=$dt_data_atasan['id_jabatan'] ?>"><?=$dt_data_atasan['nama'] ?></option>
                          <?php endforeach ?>
                        </select>
                      </div>
                      ...
                      <div class="form-password-toggle">
                        <label class="form-label" for="basic-default-password12">Alasan Pemakaian</label>
                         <input type="text-local" id="alasan_pemakaian" name="alasan_pemakaian" class="form-control" required>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="card mb-4">
                    ...
                    <div style="text-align: center;">
                      <button type="button" id="button_pengajuan_baru" class="btn btn-outline-primary">Simpan</button>
                      &nbsp;
            ...
            <script type="text/javascript">
             $(document).ready(function() {
              $("#button_pengajuan_baru").click( function() {
